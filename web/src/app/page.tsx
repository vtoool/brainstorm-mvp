  ...
  return (
    <main className="relative isolate overflow-hidden">
      <div className="pointer-events-none absolute inset-0 -z-10 opacity-80" aria-hidden="true">
        <div className="absolute inset-x-0 top-[-35%] h-[480px] bg-[radial-gradient(circle_at_top,_color-mix(in_oklab,var(--accent)_75%,_transparent)_0%,_transparent_70%)]" />
        <div className="absolute inset-0 bg-[linear-gradient(160deg,_rgba(56,189,148,0.28)_0%,_transparent_55%,_rgba(4,27,22,0.82)_100%)]" />
      </div>
      ...
      <section className="relative mx-auto flex min-h-[70vh] w-full max-w-5xl flex-col items-center justify-center px-6 py-24 text-center md:px-8">
        <div className="space-y-6">
          <p className="inline-flex items-center gap-2 rounded-full border border-white/10 bg-white/5 px-4 py-1 text-xs font-medium uppercase tracking-[0.3em] text-[var(--muted)] backdrop-blur">
            Built for mindful ideation
          </p>
          <h1 className="text-4xl font-semibold leading-tight tracking-tight text-balance md:text-5xl">
            Green Needle helps every bright idea take root.
          </h1>
          <p className="mx-auto max-w-2xl text-base text-[var(--muted)] md:text-lg">
            Capture sparks of inspiration, nurture them with context, and transform rough notes into ready-to-build concepts without losing momentum.
          </p>
        </div>
        ...
        <div className="mt-10 flex flex-wrap items-center justify-center gap-4">
          <Link
            href="/signin"
            className="inline-flex items-center gap-2 rounded-xl bg-[var(--accent)] px-5 py-3 text-sm font-medium text-white shadow-[0_25px_45px_-15px_rgba(61,214,140,0.5)] transition focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[color-mix(in_oklab,var(--accent)_70%,_white_30%)] hover:bg-[color-mix(in_oklab,var(--accent)_85%,_black_15%)]"
          >
            Start growing ideas
            ...
            return (
              ...
              >
                <div className="absolute inset-0 -z-10 opacity-0 transition group-hover:opacity-100">
                  <div className="absolute inset-0 bg-[radial-gradient(circle_at_top,_rgba(74,222,128,0.25)_0%,_transparent_65%)]" />
                </div>
